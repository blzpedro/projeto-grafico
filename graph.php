...
<body>
    <div  id="fullscreen">
        ...
        <div class="box-dia30">
            <label>R$</label><input type="text" class="input-dia30 dia30" id="input-dia30">
        ...
        <div class="box-dia5">
            <label>R$</label><input type="text" class="input-dia5 dia5" id="input-dia5">
        ...
        <div class="box-vcto">
            <label>R$</label><input type="text" class="input-vcto vcto" id="input-vcto">
